image::https://travis-ci.org/devotion/survey-api.svg?branch=to-stream-architecture[link=https://travis-ci.org/devotion/survey-api]
image::https://codecov.io/gh/devotion/survey-api/branch/master/graph/badge.svg[https://codecov.io/gh/devotion/survey-api]
